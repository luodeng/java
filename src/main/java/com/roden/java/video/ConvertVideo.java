...
public class ConvertVideo {  
    ...
    private final static String PATH = "c:\\ffmpeg\\input\\IMG_0727.MOV";  
    ...
    private static boolean processFLV(String oldfilepath) {  
        ...
        try {   
            ...
            Process proce = null;  
            String cmd = "";  
            String cut = "     c:\\ffmpeg\\bin\\ffmpeg.exe   -i   " + oldfilepath + "   -y   -f   image2   -ss   8   -t   0.001   -s   600x500   c:\\ffmpeg\\output\\" + "a.jpg";  
