...
public class MemcacheHelper {
	...
	private MemcacheHelper() {
		try {
			...
			String[] servers = "127.0.0.1:11211".split(",");// { "localhost:11211" };
			// 设置服务器权重
			// Integer[] weights = {3,2,2};
			String[] sweights = "3".split(",");
	...
	public static void main(String[] args) {
		MemcacheHelper.getInstance().add("name", "luodeng");
		System.out.println(MemcacheHelper.getInstance().get("name"));
}
}
